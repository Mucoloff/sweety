...
import dev.sweety.persistence.config.FileContainer;
...
public class ExtensionManager extends FileContainer {
    ...
    static {
        try {
            INIT = Extension.class.getDeclaredMethod("init", String.class, File.class, EcstacyLogger.class);
    ...
    private final EcstacyLogger logger = new EcstacyLogger(ExtensionManager.class).fallback();
