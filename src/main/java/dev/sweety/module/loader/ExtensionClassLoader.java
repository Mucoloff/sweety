...
public class ExtensionClassLoader extends URLClassLoader {
    ...
    public ExtensionClassLoader(final File jarFile, final ExtensionInfo info, final ClassLoader parent, File rootDir) throws Exception {
        ...
        final Constructor<? extends Extension> declaredConstructor = mainClass.asSubclass(Extension.class).getDeclaredConstructor(String.class, File.class, EcstacyLogger.class);

        declaredConstructor.setAccessible(true);

        this.extension = declaredConstructor.newInstance(info.name(), rootDir, new EcstacyLogger(mainClass).fallback());
    }
