...
import dev.sweety.core.persistence.config.compression.GzipCompressor;
import dev.sweety.core.persistence.config.format.Format;
...
public class ConfigManager<T> {
    ...
    private final SimpleLogger logger = new SimpleLogger(ConfigManager.class).fallback();
