...
public abstract class LauncherExtension extends Extension {

    protected SweetyLauncher launcher;

    protected LauncherExtension(@NotNull String name, @NotNull String version, @Nullable String description, @NotNull File folder, @NotNull SimpleLogger logger) {
