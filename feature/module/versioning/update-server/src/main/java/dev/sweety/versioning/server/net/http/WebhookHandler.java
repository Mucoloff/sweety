...
public class WebhookHandler implements HttpHandler {
    ...
    public WebhookHandler(
            ...
            PublishReleaseUseCase releaseManager,
        ...
        this.uploadLimiter = BandwidthLimiter.perSecond(Settings.UPLOAD_SPEED);
    }
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        try {
            ...
            byte[] body = uploadLimiter.readFully(exchange.getRequestBody(), Settings.MAX_WEBHOOK_BODY);
