...
import dev.sweety.versioning.server.store.WebhookRateLimitGate;
...
public class WebhookRateLimiter implements WebhookRateLimitGate {
    ...
    public boolean allow(String ip) {
        ...
        final RateWindow window = this.ip.computeIfAbsent(ip == null ? "unknown" : ip, ignored -> new RateWindow(this.rateLimitWindow));
