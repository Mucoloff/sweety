...
public class HttpUtils {
    ...
    public boolean verifySignature(String secret, String signature, byte[] body) {
    ...
    public String extractName(String header) {
    ...
    public String extractFilename(String header) {
