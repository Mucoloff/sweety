package dev.sweety.versioning.server.recode;
...
public class MainServer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        final HttpUpdateServer httpServer = new HttpUpdateServer(port, "token", releaseManager, downloadManager, cacheManager, clientRegistry);
