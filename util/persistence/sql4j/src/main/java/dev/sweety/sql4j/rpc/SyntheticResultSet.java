...
public final class SyntheticResultSet implements ResultSet {
    ...
    public Object getObject(String columnLabel) {
        throw new UnsupportedOperationException("getObject(String) — use getObject(int)");
    }
    ...
    public ResultSetMetaData getMetaData() {
        return new SyntheticMetaData(rows.length > 0 ? rows[0].length : 0);
    }
    ...
    @Override public String getString(String col) { throw new UnsupportedOperationException(); }
    @Override public boolean getBoolean(String col) { throw new UnsupportedOperationException(); }
    @Override public byte getByte(String col) { throw new UnsupportedOperationException(); }
    @Override public short getShort(String col) { throw new UnsupportedOperationException(); }
    @Override public int getInt(String col) { throw new UnsupportedOperationException(); }
    @Override public long getLong(String col) { throw new UnsupportedOperationException(); }
    @Override public float getFloat(String col) { throw new UnsupportedOperationException(); }
    @Override public double getDouble(String col) { throw new UnsupportedOperationException(); }
    @Override public BigDecimal getBigDecimal(String col, int scale) { throw new UnsupportedOperationException(); }
    ...
    @Override public Timestamp getTimestamp(String col) { throw new UnsupportedOperationException(); }
    ...
    @Override public BigDecimal getBigDecimal(String col) { throw new UnsupportedOperationException(); }
    ...
    @Override public Object getObject(String col, Map<String, Class<?>> m) { throw new UnsupportedOperationException(); }
    ...
    @Override public <T> T getObject(String col, Class<T> type) { throw new UnsupportedOperationException(); }
    @Override public int findColumn(String columnLabel) { throw new UnsupportedOperationException("findColumn(String) not supported — use column index"); }
    ...
    private static final class SyntheticMetaData implements ResultSetMetaData {
        ...
        SyntheticMetaData(int colCount) { this.colCount = colCount; }

        @Override public int getColumnCount() { return colCount; }
        ...
        @Override public String getColumnLabel(int col) { return "col" + col; }
        @Override public String getColumnName(int col) { return "col" + col; }
